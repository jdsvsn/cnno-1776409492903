...
const basePath = '/cnno-1776409492903';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional sweet rolls that exceed customer expectations, foster a sense of community, and provide unparalleled customer service, while consistently innovating and improving our products and processes.</p>
                </div>
                <div className="space-y-2">
